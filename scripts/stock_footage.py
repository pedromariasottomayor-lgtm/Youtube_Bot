...
def _extract_keywords(script: str) -> List[str]:
    ...
    keyword_map = {
        ...
        "power": "power strength leadership",
        "control": "control power leadership",
        # Concepts
        "dark": "dark night shadow mystery",
        "light": "light sunrise hope",
        "danger": "danger warning risk",
        "risk": "risk danger adventure",
        "goal": "goal target achievement",
        "dream": "dream sky clouds imagination",
        "future": "future technology city",
        "history": "history ancient old",
        # Generic
        "always": "person walking city urban",
        "never": "person alone thinking",
        "everyone": "crowd people city",
        "simple": "simple minimal clean",
        "understand": "person reading studying",
        "remember": "person remembering memories",
    }
    ...
    # Always add some generic visual keywords
    generic = [
        "person thinking deep thought",
        "city urban night lights",
        "person walking alone street",
